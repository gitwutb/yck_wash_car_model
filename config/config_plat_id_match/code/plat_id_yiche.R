...
#######################################
rm_rule<- read.csv(paste0(deep_local,"\\config\\config_file\\reg_rule.csv"),header = T,sep = ",")
out_rrc<- read.csv(paste0(deep_local,"\\config\\config_file\\out_rrc.csv"),header = T,sep = ",")
source(paste0(deep_local,"\\config\\config_fun\\fun_stopWords.R"),echo=TRUE,encoding="utf-8")
source(paste0(deep_local,"\\config\\config_fun\\fun_normalization.R"),echo=TRUE,encoding="utf-8")
...
#########################################################################################################
##################################################第二大章：数据匹配#####################################
source(paste0(deep_local,"\\config\\config_fun\\fun_match.R"),echo=TRUE,encoding="utf-8")
source(paste0(deep_local,"\\config\\config_fun\\fun_iteration.R"),echo=TRUE,encoding="utf-8")
source(paste0(deep_local,"\\config\\config_plat_id_match\\config_function\\id_match.R"),echo=TRUE,encoding="utf-8")
data_input<-qx_czb
##调用函数计算结果列表
che3001<-che300
...
write.csv(result_output,paste0(deep_local,"\\config\\config_plat_id_match\\out_yiche.csv"),row.names = F)