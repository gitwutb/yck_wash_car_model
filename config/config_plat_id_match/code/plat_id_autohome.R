...
id_autohome<-dbFetch(dbSendQuery(loc_channel,"SELECT id_che300,id_autohome FROM config_plat_id_match WHERE id_autohome!=0;"),-1)
...
write.csv(result_output,paste0(deep_local,"\\config\\config_plat_id_match\\out_autohome.csv"),row.names = F)