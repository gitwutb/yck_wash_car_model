...
yck_czb<-dbFetch(dbSendQuery(loc_channel,"SELECT years model_year,model_id car_id,brand_name,series_name,model_name model_name_t,model_price,auto car_auto,displacement liter FROM config_souhu_major_info a;"),-1)
...
write.csv(result_output,paste0(deep_local,"\\config\\config_plat_id_match\\out_souhu.csv"),row.names = F)