...
yck_czb<-dbFetch(dbSendQuery(loc_channel,"SELECT years model_year,model_id car_id,brand_name,series_name,model_name model_name_t FROM config_souhu_major_info a;"),-1)
