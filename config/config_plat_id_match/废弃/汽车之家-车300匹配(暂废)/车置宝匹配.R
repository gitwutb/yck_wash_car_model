...
yck_czb<-dbFetch(dbSendQuery(loc_channel,"SELECT model_id car_id,brand brand_name,series_name,model_name model_name_t,price model_price FROM config_chezhibao_major_info a;"),-1)
