...
library(raster)
library(stringr)
library(reshape2) #数据糅合
library(ggplot2)
#help(package="dplyr")
#读取数据
library(RMySQL)
che58_city<- read.csv("E:\\Work_table\\Study\\Rexam\\YCK\\wash_car_model\\config\\config_file\\城市牌照.csv",header = T,sep = ",")
...
input_orig<-dbFetch(dbSendQuery(loc_channel,paste0("SELECT m.car_platform,m.id_data_input,m.id_che300,p.model_year,m.brand,m.series,p.model_name,n.color,p.liter,p.auto,p.discharge_standard,p.car_level,n.location,n.regDate,n.quotes,p.model_price,n.mile,",
                                                   ...
                                                   " FROM (SELECT car_platform,id_data_input,id_che300,brand,series FROM analysis_match_id where car_platform='che168' AND match_des='right' AND date_add='",data_new,"') m",
                                                   " INNER JOIN spider_www_168 n ON m.id_data_input=n.id",
                                                   " INNER JOIN config_che300_major_info p ON m.id_che300=p.model_id;")),-1)
...
input_orig<-dbFetch(dbSendQuery(loc_channel,paste0("SELECT m.car_platform,m.id_data_input,m.id_che300,p.model_year,m.brand,m.series,p.model_name,n.color,p.liter,p.auto,p.discharge_standard,p.car_level,n.location,n.regDate,n.quotes,p.model_price,n.mile,",
                                                   ...
                                                   " FROM (SELECT car_platform,id_data_input,id_che300,brand,series FROM analysis_match_id where car_platform='rrc' AND match_des='right' AND date_add='",data_new,"') m",
...
input_orig<-dbFetch(dbSendQuery(loc_channel,paste0("SELECT m.car_platform,m.id_data_input,m.id_che300,p.model_year,m.brand,m.series,p.model_name,n.color,p.liter,p.auto,p.discharge_standard,p.car_level,n.address location,n.regDate,n.quotes,p.model_price,n.mile,",
                                                   ...
                                                   " FROM (SELECT car_platform,id_data_input,id_che300,brand,series FROM analysis_match_id where car_platform='youxin' AND match_des='right' AND date_add='",data_new,"') m",
...
input_orig<-dbFetch(dbSendQuery(loc_channel,paste0("SELECT m.car_platform,m.id_data_input,m.id_che300,p.model_year,m.brand,m.series,p.model_name,n.color,p.liter,p.auto,p.discharge_standard,p.car_level,n.location,n.regDate,n.quotes,p.model_price,n.mile,",
                                                   ...
                                                   " FROM (SELECT car_platform,id_data_input,id_che300,brand,series FROM analysis_match_id where car_platform='csp' AND match_des='right' AND date_add='",data_new,"') m",
...
input_orig<-dbFetch(dbSendQuery(loc_channel,paste0("SELECT m.car_platform,m.id_data_input,m.id_che300,p.model_year,m.brand,m.series,p.model_name,'-' color,p.liter,p.auto,p.discharge_standard,p.car_level,n.location,n.regDate,n.quotes,p.model_price,n.mile,",
                                                   " n.state,'0' trans_fee,n.transfer,n.annual,n.high_insure insure,DATE_FORMAT(n.add_time,'%Y-%m-%d')  add_time,DATE_FORMAT(n.update_time,'%Y-%m-%d') update_time,n.address",
                                                   " FROM (SELECT car_platform,id_data_input,id_che300,brand,series FROM analysis_match_id where car_platform='guazi' AND match_des='right' AND date_add='",data_new,"') m",
...
input_orig<-dbFetch(dbSendQuery(loc_channel,paste0("SELECT m.car_platform,m.id_data_input,m.id_che300,p.model_year,m.brand,m.series,p.model_name,n.color,p.liter,p.auto,p.discharge_standard,p.car_level,n.url location,n.regDate,n.quotes,p.model_price,n.mile,",
                                                   ...
                                                   " FROM (SELECT car_platform,id_data_input,id_che300,brand,series FROM analysis_match_id where car_platform='che58' AND match_des='right' AND date_add='",data_new,"') m",
...
input_orig<-dbFetch(dbSendQuery(loc_channel,paste0("SELECT m.car_platform,m.id_data_input,m.id_che300,p.model_year,m.brand,m.series,p.model_name,'' color,p.liter,p.auto,p.discharge_standard,p.car_level,n.location,n.regDate,n.quotes,p.model_price,n.mile,",
                                                   ...
                                                   " FROM (SELECT car_platform,id_data_input,id_che300,brand,series FROM analysis_match_id where car_platform='yiche' AND match_des='right' AND date_add='",data_new,"') m",
...
input_orig<-dbFetch(dbSendQuery(loc_channel,paste0("SELECT m.car_platform,m.id_data_input,m.id_che300,p.model_year,m.brand,m.series,p.model_name,'' color,p.liter,p.auto,p.discharge_standard,p.car_level,n.location,n.regDate,n.bid_price quotes,p.model_price,n.mile,",
                                                   ...
                                                   " FROM (SELECT car_platform,id_data_input,id_che300,brand,series FROM analysis_match_id where car_platform='czb' AND match_des='right' AND date_add='",data_new,"') m",
...
write.csv(wutb,"E:\\Work_table\\Study\\Rexam\\YCK\\wash_car_model\\file\\output_final\\analysis_wide_table.csv",
          row.names = F,fileEncoding = "UTF-8",quote = F)

##日志文件
n_platform<-data.frame(n_platform,date=Sys.time())
write.table(n_platform,"E:\\Work_table\\Study\\Rexam\\YCK\\wash_car_model\\file\\output_final\\analysis_wide_table.txt",row.names = F,append = T)
